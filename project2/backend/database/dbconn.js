...
const uri = `mongodb+srv://${USERNAME_DATABASE}:${PASSWORD_DATABASE}@atlascluster.gw1or1c.mongodb.net/login-signup-blog-app-bharat-intern?retryWrites=true&w=majority`;
